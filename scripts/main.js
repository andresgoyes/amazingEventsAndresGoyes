...
fetch(urlData)
    ...
    .then(fetchedData => {
        ...
        cards(data.events, cardsPlace);
        boxCheck.addEventListener("change", () => filterEvents(inputSearch, data, cardsPlace));
        inputSearch.addEventListener("input", () => filterEvents(inputSearch, data, cardsPlace));
    });